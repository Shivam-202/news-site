...
<div id="admin-content">
  ...
  <div class="row">
    ...
    <div class="col-md-offset-3 col-md-6">
        ...
        <form action="save-update-post.php?curcatid=<?php echo $row['category']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <p style="padding-top:5px;"><?php echo $row['post_img']; ?></p>
