            ...
            <div class="post-container">
                ...
                <?php
                  ...
                  $authid = $_GET['aid'];
                   ...
                   $sql1 = "SELECT * FROM post JOIN user ON post.author = user.user_id WHERE post.author = {$authid}";
                  ...
                  ?>
                    ...
                    <?php 
                     ...
                     if(mysqli_num_rows($result1) > 0){
                         ...
                         if($page > 1){
                            echo '<li><a href="author.php?aid='.($authid).'&page='.($page-1).'">Prev</a></li>';
                         }
                         for($i = 1; $i <= $total_page; $i++){
                            ...
                            echo '<li class="'.$active.'"><a href="author.php?aid='.($authid).'&page='.$i.'">'.$i.'</a></li>';
                         }
                         if($total_page > $page){
                            echo '<li><a href="author.php?aid='.($authid).'&page='.($page+1).'">Next</a></li>';
                         }
